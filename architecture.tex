...
\iffalse
    ...
    This modular architecture allows us to build a large number of library components, where developers can specify additional rules for error detection without having to specify repair actions.
